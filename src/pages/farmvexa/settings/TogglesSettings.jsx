...
const USER_EMAILS = [
  ...
  { key: 'farmerAlertHigh', label: 'High Alerts' },
  { key: 'farmerAlertMedium', label: 'Medium Alerts' },
...
const ADMIN_EMAILS = [
  { key: 'adminNewFarmer', label: 'New User Registered' },
  { key: 'adminSystemCritical', label: 'System Critical' },
  { key: 'adminGeminiEightyPercent', label: 'AI Limit 80%' },
...
const SMS_TOGGLES = [
  { key: 'farmerApproved', label: 'Account Approved' },
  { key: 'farmerWelcome', label: 'Welcome SMS' },
  { key: 'farmerAlertHigh', label: 'High Alerts' },
  { key: 'farmerDiseaseDetected', label: 'Disease Detected' },
  { key: 'farmerDeviceOffline', label: 'Device Offline' },
  { key: 'adminNewFarmer', label: 'New User' },
  { key: 'adminSystemCritical', label: 'System Critical' },
  { key: 'adminGeminiExceeded', label: 'AI Limit Exceeded' },
  { key: 'adminPythonOffline', label: 'Python AI Offline' },
];
...
export default function TogglesSettings({ settings, setSettings, onSave, saving }) {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <Card>
        <h2 className="font-semibold text-[var(--text-primary)] mb-4">User Email Notifications</h2>
        <div className="space-y-4 divide-y divide-[var(--border-color)]">
          {USER_EMAILS.map(item => (
      ...
      <Card>
        <h2 className="font-semibold text-[var(--text-primary)] mb-4">Admin Email Notifications</h2>
        <div className="space-y-4 divide-y divide-[var(--border-color)]">
