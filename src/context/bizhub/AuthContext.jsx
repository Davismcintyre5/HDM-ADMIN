...
import { login as loginApi, setAuthToken, setupInterceptors } from '../../services/bizhub';

const AuthContext = createContext(null);

export function AuthProvider({ children }) {
  const [admin, setAdmin] = useState(() => {
    try { return JSON.parse(localStorage.getItem('bizhub_admin')); } catch { return null; }
  });
  const [token, setToken] = useState(localStorage.getItem('bizhub_token') || null);
