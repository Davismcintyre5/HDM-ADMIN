...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 z-50 h-full bg-[var(--sidebar-bg)] border-r border-[var(--border-color)]
      ...
      `}>
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-[var(--border-color)]">
          ...
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-[var(--sidebar-hover)] text-[var(--text-secondary)] hidden lg:block"
          >
