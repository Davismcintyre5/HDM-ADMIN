...
export default function Layout() {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)]"><Spinner size="lg" /></div>;
  }
  if (!isAuthenticated) {
    return <Navigate to="/flax/login" state={{ from: location }} replace />;
  }
