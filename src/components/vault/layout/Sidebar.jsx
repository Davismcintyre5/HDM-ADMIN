...
import { HiViewGrid, HiClipboardCheck, HiUsers, HiOfficeBuilding, HiDeviceMobile, HiDocumentReport, HiCash, HiCog, HiChevronLeft, HiChevronRight, HiX, HiHome } from 'react-icons/hi';
