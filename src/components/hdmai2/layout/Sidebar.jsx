...
import {
  HiHome, HiUsers, HiKey, HiChip, HiCube, HiScale,
  HiHeart, HiCog, HiClipboardList, HiDatabase,
  HiChevronLeft, HiChevronRight, HiX,HiCash 
} from 'react-icons/hi';

const navItems = [
  { to: '/hdmai2', icon: HiHome, label: 'Dashboard', end: true },
  { to: '/hdmai2/users', icon: HiUsers, label: 'Users' },
  { to: '/hdmai2/api-keys', icon: HiKey, label: 'API Keys' },
  { to: '/hdmai2/jobs', icon: HiChip, label: 'Training Jobs' },
  { to: '/hdmai2/models', icon: HiCube, label: 'Models' },
  { to: '/hdmai2/plans', icon: HiCube, label: 'Plans' },
  { to: '/hdmai2/legals', icon: HiScale, label: 'Legals' },
  { to: '/hdmai2/payments', icon: HiCash, label: 'Payments' },
  { to: '/hdmai2/health', icon: HiHeart, label: 'Health' },
  { to: '/hdmai2/settings', icon: HiCog, label: 'Settings' },
  { to: '/hdmai2/logs', icon: HiClipboardList, label: 'Logs' },
  { to: '/hdmai2/backup', icon: HiDatabase, label: 'Backup' },
];
