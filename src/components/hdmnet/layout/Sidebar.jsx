...
import { HiHome, HiUsers, HiCreditCard, HiCog, HiArchive, HiChevronLeft, HiChevronRight, HiX } from 'react-icons/hi';

const navItems = [
  { to: '/hdmnet', icon: HiHome, label: 'Dashboard', end: true },
  { to: '/hdmnet/owners', icon: HiUsers, label: 'Owners' },
  { to: '/hdmnet/plans', icon: HiCreditCard, label: 'Plans' },
  { to: '/hdmnet/settings', icon: HiCog, label: 'Settings' },
  { to: '/hdmnet/backups', icon: HiArchive, label: 'Backups' },
];
    ...
    <>
      ...
      >
        <div className="h-16 flex items-center justify-between px-4 border-b border-[var(--border-color)] bg-cyan-600">
          ...
          <button onClick={() => setMobileSidebarOpen(false)} className="p-1.5 rounded-lg hover:bg-white/20 text-white lg:hidden">
